...
await cp(new URL('../public/hero-david-cutout-v1.webp', import.meta.url), new URL('hero-david-cutout-v1.webp', docs));
await cp(new URL('../public/hero-david-cutout-v2.webp', import.meta.url), new URL('hero-david-cutout-v2.webp', docs));
await cp(new URL('../public/jj-mark.webp', import.meta.url), new URL('jj-mark.webp', docs));
...
await cp(new URL('../public/face-marble-v2.webp', import.meta.url), new URL('face-marble-v2.webp', docs));
await cp(new URL('../public/chest-marble-v2.webp', import.meta.url), new URL('chest-marble-v2.webp', docs));
...
await cp(new URL('../public/program-face-symbol-v3.webp', import.meta.url), new URL('program-face-symbol-v3.webp', docs));
await cp(new URL('../public/program-body-organic-v10.webp', import.meta.url), new URL('program-body-organic-v10.webp', docs));
await cp(new URL('../public/program-private-valley-v3.webp', import.meta.url), new URL('program-private-valley-v3.webp', docs));
await cp(new URL('../public/cynosure-product-lineage.png', import.meta.url), new URL('cynosure-product-lineage.png', docs));
await cp(new URL('../public/cynosure-product-lineage.webp', import.meta.url), new URL('cynosure-product-lineage.webp', docs));
...
await cp(new URL('../public/apogee-elite-plus-device-cutout.webp', import.meta.url), new URL('apogee-elite-plus-device-cutout.webp', docs));
...
await cp(new URL('../public/care-before-shaving.webp', import.meta.url), new URL('care-before-shaving.webp', docs));
await cp(new URL('../public/care-after-sunscreen.webp', import.meta.url), new URL('care-after-sunscreen.webp', docs));
await cp(new URL('../public/strengths-hesitation.webp', import.meta.url), new URL('strengths-hesitation.webp', docs));
