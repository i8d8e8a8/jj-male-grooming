...
<iframe id="jj-grooming-frame" src="/child/sub/landing/male-grooming/${page}.html?v=${page === 'depilation-areas' ? '20260901b' : '20260901a'}" title="${label}" scrolling="no" loading="eager"></iframe>
</div></div></div>
...
await writeFile(path.join(shared, 'depilation-areas.html'), variant('https://jj-man.co.kr/child/sub/depilation/2.php', 'depilation-areas-v2.css'));
await writeFile(path.join(shared, 'depilation-info.css'), '.program,.pricing,.consultation,.mobileBar{display:none!important}\n');
await writeFile(path.join(shared, 'depilation-areas-v2.css'), '.hero,.intro,.strengths,.equipment,.videos,.process,.careGuide,.faq,.consultation,.mobileBar{display:none!important}\n');
