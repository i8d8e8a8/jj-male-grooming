...
<iframe id="jj-grooming-frame" src="/child/sub/landing/male-grooming/${page}.html?v=${page === 'depilation-areas' ? '20260901g' : '20260901a'}" title="${label}" scrolling="no" loading="eager"></iframe>
</div></div></div>
