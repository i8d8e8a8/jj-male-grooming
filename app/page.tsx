...
export default function Home() {
  return <main data-reveal-root><RevealMotion/>
    ...
    <section className="faq wrap"><header className="sectionTitle"><p className="label blue">제모 상담 안내</p><h2>자주 묻는 질문</h2></header><div className="faqList">{faqs.map(([q, a], i) => <article className="faqItem" tabIndex={0} key={q}><div className="faqQuestion"><span>0{i + 1}</span><b>{q}</b><i>＋</i></div><p className="faqAnswer">{a}</p></article>)}</div></section>
