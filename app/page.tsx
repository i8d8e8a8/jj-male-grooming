...
export default function Home() {
  return <main data-reveal-root><RevealMotion/>
    ...
    <section className="careGuide"><div className="wrap careColumns"><article><Icon name="before"/><h3>시술 전 확인사항</h3><p>시술 1~2일 전 면도기로 가볍게 면도해 주세요. 털을 뽑거나 왁싱하면 레이저가 목표로 하는 모근이 사라질 수 있습니다. 최소 2주간 선탠과 과도한 야외 활동도 피해주세요.</p></article><article><Icon name="after"/><h3>시술 후 관리</h3><p>당일 미온수 샤워는 가능하며 3~5일간 사우나·찜질방·격한 운동을 피해주세요. 노출 부위에는 자외선 차단제를 꼼꼼히 사용하고 이상 반응이 지속되면 의료진에게 문의하세요.</p></article></div></section>
